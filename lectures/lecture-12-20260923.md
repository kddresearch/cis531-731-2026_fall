...
**Speaker Notes:**
Welcome to Lecture 12. On Monday, we covered the Akidau framework and the fundamental differences between batch and stream processing. Today, we are moving from theory to execution using Apache Spark 3.5.7. We will explore Spark Structured Streaming, which allows us to treat live data streams as continuously appending relational tables. 
